-- Seed: 7 test partners with synthetic products (flowers, chocolates, limos, movies, events, restaurant, baby)
-- Run after migrations and seed.sql. Each partner has ~15 products across categories, approved for testing.
-- Tots Trunk: baby/newborn items + pre-bundled products for testing bundle-in-bundle flows.
...
INSERT INTO capability_tags (tag_name, tag_category, description) VALUES
  ...
  ('baby', 'product', 'Baby and newborn items'),
  ('newborn', 'product', 'Newborn essentials'),
  ('gifts', 'product', 'Gift sets and bundles'),
  ('bundle', 'product', 'Pre-bundled product (multiple items as one)')
...
-- Partner 7: Tots Trunk - newborn baby items + pre-bundled products (bundle capability for testing)
INSERT INTO products (id, partner_id, name, description, price, currency, capabilities, is_eligible_search, is_eligible_checkout, availability, created_at, updated_at) VALUES
  ('a1000007-0001-4001-8001-000000000001', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Newborn Onesie Set', '5-pack organic cotton onesies - newborn essentials', 34.99, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000002', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Swaddle Blankets Pack', '4 muslin swaddle blankets - newborn sleep', 29.99, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000003', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Glass Baby Bottles Set', '4 BPA-free glass bottles with nipples - newborn feeding', 42.00, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000004', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Newborn Diaper Pack', '120 count newborn diapers - hypoallergenic', 44.99, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000005', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Baby Wipes Sensitive', '8-pack fragrance-free wipes - newborn care', 24.99, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000006', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Pacifier Set', '6-pack orthodontic pacifiers - newborn soothing', 18.99, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000007', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Burp Cloths 6-Pack', 'Absorbent burp cloths - newborn feeding', 22.00, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000008', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Baby Bibs Set', '5 silicone bibs - newborn and infant feeding', 19.99, 'USD', '["baby","newborn"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-000000000009', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Newborn Essentials Kit', 'Pre-bundled: onesies, swaddles, bottles, diapers, wipes - complete newborn starter', 149.99, 'USD', '["baby","newborn","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-00000000000a', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Baby Shower Gift Bundle', 'Pre-bundled: blanket, onesie set, bibs, burp cloths - perfect baby shower gift', 89.99, 'USD', '["baby","gifts","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-00000000000b', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'First 6 Months Starter Kit', 'Pre-bundled: diapers, wipes, bottles, pacifiers, bibs - first six months covered', 129.99, 'USD', '["baby","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-00000000000c', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Hospital Go-Bag', 'Pre-bundled: onesies, swaddles, diapers, wipes - ready for hospital discharge', 79.99, 'USD', '["baby","newborn","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-00000000000d', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Nursery Starter Set', 'Pre-bundled: crib sheets, swaddles, blankets - nursery essentials', 99.99, 'USD', '["baby","newborn","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-00000000000e', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Welcome Home Baby Bundle', 'Pre-bundled: full newborn kit + gift wrap - welcome baby home', 199.99, 'USD', '["baby","newborn","gifts","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW()),
  ('a1000007-0001-4001-8001-00000000000f', 'a1000007-9c0b-4ef8-bb6d-6bb9bd380a07', 'Baby Care Combo', 'Pre-bundled: wipes, diapers, lotion, shampoo - daily care essentials', 59.99, 'USD', '["baby","bundle"]'::jsonb, true, true, 'in_stock', NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, capabilities = EXCLUDED.capabilities, updated_at = NOW();
